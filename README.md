...
| `threshold (default)` | 0.4 | Порог для классификации (вероятность >= 0.4 → мошенничество) |
...
![SHAP Feature Importance](shap/shap_feature_importance.png)
...
![SHAP Summary Plot](shap/shap_summary_plot.png)
...
Подробная интерактивная визуализация SHAP values доступна в файле: **[shap_summary.html](shap/shap_summary.html)**
